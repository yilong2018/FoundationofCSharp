...
namespace DataAccessLibrary
{
    public class CosmosDataAccess
    {
        ...
        public CosmosDataAccess(string endpointUrl,
                                string primaryKey,
                                string databaseName,
        ...
        public async Task<T> LoadRecordByIdAysnc<T>(string id)
        {
        ...
        public async Task DelketeRecordAsync<T>(string id, string partitionKey){
